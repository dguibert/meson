...
class MachineInfo:
    def __init__(self) -> None:
        self.compilers: Dict[str, Union[str, List[str]]] = {}
        self.binaries: Dict[str, Union[str, List[str]]] = {}
...
def locate_path(program: str) -> str:
...
def detect_cross_env(options: Any) -> MachineInfo:
    if options.debarch:
        ...
        sys.exit('Can currently only detect debianlike cross envs. Patches welcome.')
    return infos
